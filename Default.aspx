...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Label ID="id_estudiante" runat="server" CssClass="badge" Text="Codigo Del Estudiante"></asp:Label>
    <asp:TextBox ID="txt_id_estudiante" runat="server" CssClass="form-control" placeholder="---"></asp:TextBox>
    <asp:Label ID="carnet" runat="server" CssClass="badge" Text="Carnet del Estudiante"></asp:Label>
    <asp:TextBox ID="lbl_carnet" runat="server" CssClass="form-control" placeholder="E001"></asp:TextBox>
